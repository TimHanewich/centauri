...
- Telemetry
    ...
    - [Saved as .xlsx with comments](https://github.com/TimHanewich/centauri/releases/download/55/log.xlsx)
- Onboard video
...
- Short Clips
    - [Blast off](https://github.com/TimHanewich/centauri/releases/download/54/export2.mp4)
...
- Flight #4 (3 seconds)
- Flight #5 (171 seconds) = onboard clip #3, 04:17 to 07:15 of gopro clip #4
    - With Telemetry: [on youtube](https://youtu.be/ITHsxJEDtdI), [download](https://github.com/TimHanewich/centauri/releases/download/56/export1.mp4)
