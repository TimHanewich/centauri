...
![transmitter](https://i.imgur.com/WHcm26P.jpeg)
...
The all-up transmitter is composed of three key components working together to transmit and receive flight data. All three components are depicted below:

![3-part transmitter](https://i.imgur.com/ysyQIHS.png)
