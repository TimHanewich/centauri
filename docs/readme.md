...
- Logos
    ...
    - [Centauri Combination Mark (with wording) logo SVG](https://github.com/TimHanewich/centauri/releases/download/11/centauri_combination_mark.svg)
- Slides/Diagrams
    - [Centauri home screen banner (PowerPoint slide)](https://github.com/TimHanewich/centauri/releases/download/10/banner.pptx) (from home page)
