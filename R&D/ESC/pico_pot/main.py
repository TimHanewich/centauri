# This main calibration code taken from my Scout quadcopter project in 2023: github.com/TimHanewich/Scout
# modified it further to show the throttle level (as a %) on a small SSD-1306 OLED display.
...
while True:
    ...
    # display
    oled.fill(0)
    oled.text(str(round(percent * 100, 0)) + "%", 0, 0)
    oled.text(str(nanoseconds), 0, 12)
    oled.show()
