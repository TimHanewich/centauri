...
- Drone --> Controller
    - Telemetry Packet
        ...
        - Pitch Angle Estimate: 1 signed byte, interpretted literally
        - Roll Angle Estimate: 1 signed byte, interprettyed literally
    - Special Packet (text)
        - Metadata byte:
            - Bit 7: *reserved*
            - Bit 6: *reserved*
...
## Other Resources
- [communication.pptx](https://github.com/TimHanewich/centauri/releases/download/63/communication.pptx)